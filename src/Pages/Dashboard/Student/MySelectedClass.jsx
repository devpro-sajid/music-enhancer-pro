...
const MySelectedClass = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Music Enhancer | Selected Classes</title>
            </Helmet>
                                    ...
                                    {selectedClasses?.map(classItem => {
                                        return (
                                            <tr className="border-b last:border-0 dark:border-neutral-500" key={classItem?._id}>
                                                ...
                                                <td className="whitespace-nowrap px-6 py-4"><button className='bg-prime py-1 px-5 font-semibold text-white rounded-md'>Pay</button></td>
