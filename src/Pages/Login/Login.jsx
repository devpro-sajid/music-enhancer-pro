                ...
                <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                    ...
                    <div className="md:w-1/2 px-6 md:px-16">
                        ...
                        <form action="" className="flex flex-col gap-4">
                            <input className="p-2 mt-8 rounded-md border" type="email" name="email" placeholder="Email"/>
                                <div className="relative">
                                    <input className="p-2 rounded-md border w-full" type="password" name="password" placeholder="Password"/>
                        ...
                        <div className="mt-6 grid grid-cols-3 items-center text-gray-400">
                            <hr className="border-gray-400"/>
                                ...
                                <div className="mt-3 text-xs flex justify-between items-center text-black">
                                    ...
                                    <button className="py-2 px-5 bg-white border rounded-md hover:scale-110 duration-300">Register</button>
                                </div>
                        </div>
